...
public class Search_Ing_Group_Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ing_people = new ArrayList<>();
        ing_ser = new ArrayList<>();
    ...
    private void parseJson(String myResponse) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                startDate.add(start_date);
                moviesList.add(mountain_name);
                groupName.add(name);
                moviesList2.add(points);
                images.add(image);
                ing_people.add(total_num);
                ing_ser.add(description);
                groupId.add(id);
    ...
    public class MyAdapter extends RecyclerView.Adapter<Search_Ing_Group_Screen.MyAdapter.MyViewHolder> implements Filterable {
        ...
        Context context;
        ArrayList<String> moviesList, moviesList2, moviesListAll, images, startDate, groupName;


        private MyAdapter(Context context, ArrayList<String> moviesList, ArrayList<String> moviesList2, ArrayList<String> images, ArrayList<String> startDate, ArrayList<String> groupName) {
        ...
        public void onBindViewHolder(@NonNull Search_Ing_Group_Screen.MyAdapter.MyViewHolder holder, int position) {
            ...
            holder.dateText.setText(startDate.get(position));
            holder.groupNameText.setText(groupName.get(position));
            ...
            holder.mainLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("points", moviesList2.get(position));
                    ...
                    intent.putExtra("start_date", startDate.get(position));
                    intent.putExtra("total_people", ing_people.get(position));
                    intent.putExtra("des", ing_ser.get(position));
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            TextView myText1, myText2, dateText, groupNameText;
            ImageView myImage;
            ...
            public MyViewHolder(@NonNull View itemView) {
                ...
                dateText = itemView.findViewById(R.id.textView11);
                groupNameText = itemView.findViewById(R.id.textView13);
